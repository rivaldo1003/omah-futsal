...
<head>
    ...
    <style>
        ...
        .dot-draw { background: var(--warning); }
        ...
        .gd-positive { background: rgba(16, 185, 129, 0.1); color: var(--success); }
        .gd-negative { background: rgba(239, 68, 68, 0.1); color: var(--danger); }
        .gd-neutral { background: #f1f5f9; color: var(--secondary); }
        ...
        .qual-q { background: rgba(16, 185, 129, 0.2); color: var(--success); }
        .qual-p { background: rgba(245, 158, 11, 0.2); color: var(--warning); }
                            ...
                            <tbody>
                                @foreach($groupStandings as $index => $team)
                                    @php
                                        ...
                                        elseif ($index < 6) $positionClass = 'pos-4-6';
                                        else $positionClass = 'pos-7-10';
                                        ...
                                        $gdClass = $gdValue > 0 ? 'gd-positive' : ($gdValue < 0 ? 'gd-negative' : 'gd-neutral');
            ...
            <div class="empty-state-compact">
                ...
                @if(isset($tournaments) && $tournaments->count() > 0)
                    <div class="tournament-buttons">
                        @foreach($tournaments as $tournament)
                            <a href="{{ route('standings') }}?tournament_id={{ $tournament->id }}" 
