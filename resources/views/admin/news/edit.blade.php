                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" id="category"
                                        ...
                                        <option value="Tournament"
                                            {{ old('category', $article->category) == 'Tournament' ? 'selected' : '' }}>
                                            Tournament</option>
                                        <option value="Match"
                                            {{ old('category', $article->category) == 'Match' ? 'selected' : '' }}>Match
                                        </option>
                                        <option value="Team"
                                            {{ old('category', $article->category) == 'Team' ? 'selected' : '' }}>Team
                                        </option>
                                        <option value="Player"
                                            {{ old('category', $article->category) == 'Player' ? 'selected' : '' }}>
                                            Player</option>
                                        <option value="Event"
                                            {{ old('category', $article->category) == 'Event' ? 'selected' : '' }}>Event
                                        </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="current-image-container">
                                        <img src="{{ asset($article->image_url) }}" alt="Current Image"
...
<!-- Show alert when removing image -->
<script>
        ...
        reader.onload = function(e) {
            ...
            if (previewContainer) {
                previewContainer.innerHTML = `
                    <img src="${e.target.result}" alt="Preview" class="img-thumbnail mb-2" style="max-height: 200px;">
                    <div class="form-check">
