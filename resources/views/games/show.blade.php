                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="match-info-item">
                                    ...
                                    <div class="match-info-content">
                                        <h6>Time</h6>
                                        <p>{{ date('H:i', strtotime($game->time_start)) }} - {{ date('H:i', strtotime($game->time_end)) }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            @foreach($game->homeTeam->players as $player)
                                <div class="player-card">
                                    ...
                                    <div class="player-stats">
                                        @if($player->goals > 0)
                                            <span class="badge bg-success">{{ $player->goals }}G</span>
                                        @endif
                                        @if($player->assists > 0)
                                            <span class="badge bg-primary">{{ $player->assists }}A</span>
                                        @endif
                                        @if($player->yellow_cards > 0)
                                            <span class="badge bg-warning">{{ $player->yellow_cards }}Y</span>
                                        @endif
                                        @if($player->red_cards > 0)
                                            <span class="badge bg-danger">{{ $player->red_cards }}R</span>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
                ...
                @if($game->tournament)
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="small text-muted mb-3">{{ $game->tournament->description ?? 'No description available' }}</p>
                            <div class="match-info-item">
                                <div class="match-info-icon">
                                ...
                                <div class="match-info-content">
                                    ...
                                    <p>{{ $game->tournament->start_date->format('d M Y') }} - {{ $game->tournament->end_date->format('d M Y') }}</p>
                                </div>
                            </div>
                            <div class="match-info-item">
                                <div class="match-info-icon">
                                ...
                                <div class="match-info-content">
                                    <h6>Status</h6>
                                    <p>
                                        <span class="badge bg-{{ $game->tournament->status == 'ongoing' ? 'success' : ($game->tournament->status == 'upcoming' ? 'warning' : 'secondary') }}">
